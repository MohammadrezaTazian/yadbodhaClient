...
export default function FamilyTreePersonChildModal(props: PropsModel) {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      {contextHolder}
      <Modal
        title={'تعریف فرزند برای شجره نامه'}
        centered
          ...
          <Form form={form} layout="vertical" className="form-width">
            ...
            <Row gutter={24}>
              <Col xs={24} sm={24} style={{ marginBottom: '20px', color: 'aqua' }}>
                تعریف فرزند برای <span className="label">{props.familyTreePerson?.familyTreePersonName}</span>
              </Col>
              <Col xs={24} sm={12} span={12}>
                <Form.Item name="familyTreePersonName" label="نام فرزند" rules={[{ required: true, message: 'لطفاً نام را وارد کنید!' }]}>
