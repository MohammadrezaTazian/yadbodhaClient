...
export default function FamilyTreeAccessModal(props: PropsModel) {
  const [form] = Form.useForm<FamilyTreePersonsAccessModel | null>();
  ...
  const initForm = async () => {
    form.setFieldsValue({
      mobile: undefined,
      name: null,
      familyTreeId: props.familyTreeId,
    });
  };
  ...
  const onOk = async () => {
    try {
      ...
      await familyTreeServices.familyTreePersonAccessAdd(values);
